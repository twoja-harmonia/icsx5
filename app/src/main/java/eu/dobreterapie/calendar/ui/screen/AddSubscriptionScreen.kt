...
import eu.dobreterapie.calendar.model.AddSubscriptionModel
import eu.dobreterapie.calendar.ui.ResourceInfo
import eu.dobreterapie.calendar.ui.partials.ExtendedTopAppBar
import eu.dobreterapie.calendar.ui.views.EnterUrlComposable
import eu.dobreterapie.calendar.ui.views.SubscriptionSettingsComposable
...
fun AddSubscriptionScreen(
    ...
    onSubscriptionCreated: () -> Unit = onBackRequested
) {
    ...
    LaunchedEffect(Unit) {
        ...
        // If URL was provided (e.g. from QR scan), auto-validate to skip page 0
        ...
        AddSubscriptionScreen(
            ...
            onNextRequested = { page: Int ->
                when (page) {
                    ...
                    1 -> {
                        model.createSubscription().invokeOnCompletion { onSubscriptionCreated() }
                    }
                }
            },
            onNavigationClicked = {
                    ...
                    Button(
                        ...
                        Text(
                            if (pagerState.currentPage == 1)
                                stringResource(R.string.add_calendar_sync_button).uppercase()
                            else
                                stringResource(R.string.activity_add_calendar_subscribe).uppercase()
                        )
                    }
                }
            }
